...
//  * + 화살표 함수 ( 함수 표현식 ) 으로 작성해도 되고, 함수 선언문으로 작성해도 된다.
//  * 
//  * defaultProps 부모 컴포넌트에서 props가 전달되지 않을 경우 기본적으로 적용할 props
//  */
...
//       <p> p 태그 : 새로운 컴포넌트의 이름은!!{props.name}</p>
//       <h3> h3 태그 : 새로운 컴포넌트의 이름은!!{name}</h3>
//     </>
//   )
// }

// // FunctionComponentExample.defaultProps = {
// //   name : '디폴트 프롶스',
// // }

// FunctionComponentExample.propTypes = {
//   name : PropTypes.string.isRequired
// }

// /**
//  * 리액트 18 부터, React.StrictMode 가 기본적으로 활성화가 됩니다.
//  * 개발모드에서 컴포넌트의 랜더링과 라이프사이클 메서드가
//  * 부작용을 테스트 하고 식별하는 데 도움을 줍니다.
//  * 이로 인해서 log 가 두번 찍힐 수 있습니다.
//  */
